...
# 1800 s = 30 min since first deployment can take between 15 and 20 minutes which could then fail like so:
...
wget https://raw.githubusercontent.com/andreasluckert/aws-sm-notebook-instance/main/autostop.py
